...
void loop(){
    ...
    if (body.status == 3) {
      ...
      Serial.println(String(heartRate) + "," + String(oxygen) + "," + String(confidence) + "," + String(rValue));}
    // Slow it down or your heart rate will go up trying to keep up with the flow of numbers
    delay(250); 
