...
class channelPositionalEncoding(signalEncoderModules):
    def __init__(self, sequenceBounds=(90, 300)):
        ...
        for modelInd in range(self.numOperatorLayers):
            ...
            self.learnNeuralOperatorLayers.append(waveletNeuralOperatorLayer(numInputSignals=1, numOutputSignals=1, sequenceBounds=sequenceBounds, numDecompositions=2, wavelet='bior3.7', mode='zero', numLayers=1, encodeLowFrequency=True, encodeHighFrequencies=False))
            self.unlearnNeuralOperatorLayers.append(waveletNeuralOperatorLayer(numInputSignals=1, numOutputSignals=1, sequenceBounds=sequenceBounds, numDecompositions=2, wavelet='bior3.7', mode='zero', numLayers=1, encodeLowFrequency=True, encodeHighFrequencies=False))
