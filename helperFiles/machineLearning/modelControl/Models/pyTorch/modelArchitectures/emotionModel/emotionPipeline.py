            ...
            for dataInd, data in enumerate(dataLoader):
                ...
                with self.accelerator.accumulate(model):
                    ...
                    if submodel == "signalEncoder":
                        ...
                        if (finalLoss < 0.1 and 0.4 < encodedSignalStandardDeviationLoss) or 0.75 < encodedSignalStandardDeviationLoss:
                        ...
                        if (finalLoss < 0.1 < encodedSignalMeanLoss) or 0.2 < encodedSignalMeanLoss:
