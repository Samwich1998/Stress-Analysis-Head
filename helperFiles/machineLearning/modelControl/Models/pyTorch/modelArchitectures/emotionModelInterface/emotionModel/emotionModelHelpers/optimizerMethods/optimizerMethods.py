...
class optimizerMethods:
    ...
    def getModelParams(submodel, signalEncoderModel, autoencoderModel, signalMappingModel, sharedEmotionModel, specificEmotionModel):
        modelParams = [
            ...
            {'params': signalEncoderModel.parameters(), 'weight_decay': 1E-8, 'lr': 5E-5}]  # Empirically: 1E-10 < weight_decay < 1E-6; 5E-5 < lr < 5E-4
    ...
    def addOptimizer(self, submodel, signalEncoderModel, autoencoderModel, signalMappingModel, sharedEmotionModel, specificEmotionModel):
        ...
        # Set the optimizer.
        optimizer = self.setOptimizer(modelParams, lr=5E-5, weight_decay=1E-8, submodel=submodel, optimizerType=self.userInputParams["optimizerType"])
