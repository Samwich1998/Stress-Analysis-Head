...
class optimizerMethods:
    ...
    def addOptimizer(self, submodel, model, signalEncoderModel, autoencoderModel, signalMappingModel, sharedEmotionModel, specificEmotionModel):
        ...
        # Set the optimizer.
        constrainedOptimizer = self.setOptimizer(constrainedModelParams, lr=1E-3, weight_decay=1E-6, submodel=submodel, optimizerType=self.userInputParams["optimizerType"])
