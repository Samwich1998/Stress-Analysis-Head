...
class changeVariance(signalEncoderModules):
    ...
    def adjustSignalVariance(self, inputData):
        return self.encodingInterface_reshapeMethod(inputData, self.adjustSignals)

    def unAdjustSignalVariance(self, inputData):
        return self.encodingInterface_reshapeMethod(inputData, self.removeSignalAdjustment)
