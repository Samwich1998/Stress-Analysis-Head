...
class signalEncoderModules(convolutionalHelpers):
    ...
    def projectionOperator(self, inChannel=2, outChannel=1):
        return nn.Sequential(
            ...
            # Convolution architecture: residual connection, feature engineering
            self.convolutionalFiltersBlocks(numBlocks=3, numChannels=[outChannel, outChannel], kernel_sizes=3, dilations=1, groups=1, strides=1, convType='conv1D', activationType='boundedExp', numLayers=None, useSwitchActivation=True),
        )
