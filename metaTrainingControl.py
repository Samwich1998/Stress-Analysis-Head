...
if __name__ == "__main__":
    ...
    trainingDate = "2024-05-14 selu 48-4"  # The current date we are training the model. Unique identifier of this training set.
    ...
    parser.add_argument('--optimizerType', type=str, default='ASGD', help='The optimizerType used during training convergence: Options: RMSprop, Adam, AdamW, SGD, etc.')
