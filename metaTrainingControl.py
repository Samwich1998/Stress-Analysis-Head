...
if __name__ == "__main__":
    ...
    trainingDate = "2024-05-11"  # The current date we are training the model. Unique identifier of this training set.
    ...
    if userInputParams['deviceListed'].startswith("HPC"):
        ...
        if args.submodel == "signalEncoder":
            if args.numLiftedChannels <= 32 and args.numEncodingLayers <= 3:
