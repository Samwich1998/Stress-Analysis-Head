...
if __name__ == "__main__":
    ...
    trainingDate = "2024-05-22"  # The current date we are training the model. Unique identifier of this training set.
    ...
    parser.add_argument('--numPosLiftedChannels', type=int, default=1, help='The number of channels to lift to during positional encoding. Range: (1, 4, 1)')
    ...
    parser.add_argument('--numPosEncodingLayers', type=int, default=6, help='The number of operator layers during positional encoding. Range: (0, 4, 1)')
