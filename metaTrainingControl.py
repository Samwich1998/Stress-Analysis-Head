...
if __name__ == "__main__":
    ...
    trainingDate = "2024-06-04 optimizer analysis"  # The current date we are training the model. Unique identifier of this training set.
    ...
    parser.add_argument('--signalEncoderWaveletType', type=str, default='bior2.4', help='The wavelet type for the wavelet transform: bior3.7, db3, dmey, etc')
    ...
    parser.add_argument('--numSigEncodingLayers', type=int, default=1, help='The number of operator layers during signal encoding. Range: (0, 6, 1)')
